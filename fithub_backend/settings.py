"""
Django settings for fithub_backend project.
...
SECRET_KEY = 'django-insecure-$hx^u9*3nwq)ifc^7#2vlsk(p^3rc&(ofn@$-z54%xr94qbkyk'
...
ROOT_URLCONF = 'fithub_backend.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'fithub_backend.wsgi.application'
